...
local Window = Rayfield:CreateWindow({
   Name = "RullzsyHUB | MOUNT KAWAH EXPEDITION (PRO)",
   Icon = "braces",
...
local jsonFolder = mainFolder .. "/json_mount_kawah_terjun_pro_patch_new_001"
...
local baseURL = "https://raw.githubusercontent.com/0x0x0x0xblaze/json/refs/heads/main/json_kawah_expedition_pro/"
local jsonFiles = {
    "spawnpoint.json",
    "checkpoint_1.json",
	"checkpoint_2.json",
...
local function startManualAutoWalkSequence(startCheckpoint)
    ...
    local function playNext()
        ...
        if currentCheckpoint > #jsonFiles then
            ...
            Rayfield:Notify({
                Title = "Auto Walk (Manual)",
                Content = "Semua checkpoint selesai! silahkan ganti mode ke hard lagi untuk balik ke base camp.",
                Duration = 4,
                Image = "check-check"
            })
            return
