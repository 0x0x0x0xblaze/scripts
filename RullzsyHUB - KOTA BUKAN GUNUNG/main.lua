...
local jsonFolder = mainFolder .. "/json_kota_bukan_gunung_patch_new_001"
...
local baseURL = "https://raw.githubusercontent.com/0x0x0x0xblaze/json/refs/heads/main/json_kota_bukan_gunung/"
local jsonFiles = {
    "checkpoint_1.json",
	"checkpoint_2.json",
	"checkpoint_3.json",
...
local Toggle = AutoWalkTab:CreateToggle({
    ...
    Callback = function(Value)
        if Value then
            playSingleCheckpointFile("checkpoint_8.json", 7)
        else
            autoLoopEnabled = false
            isManualMode = false
            stopPlayback()
...
local Toggle = AutoWalkTab:CreateToggle({
    ...
    Callback = function(Value)
        if Value then
            playSingleCheckpointFile("checkpoint_9.json", 8)
        else
            autoLoopEnabled = false
            isManualMode = false
            stopPlayback()
...
local Toggle = AutoWalkTab:CreateToggle({
    ...
    Callback = function(Value)
        if Value then
            playSingleCheckpointFile("checkpoint_11.json", 9)
        else
            autoLoopEnabled = false
            isManualMode = false
            stopPlayback()
...
local Toggle = AutoWalkTab:CreateToggle({
    ...
    Callback = function(Value)
        if Value then
            playSingleCheckpointFile("checkpoint_12.json", 10)
        else
            autoLoopEnabled = false
            isManualMode = false
            stopPlayback()
...
local Toggle = AutoWalkTab:CreateToggle({
    ...
    Callback = function(Value)
        if Value then
            playSingleCheckpointFile("checkpoint_13.json", 11)
        else
            autoLoopEnabled = false
            isManualMode = false
            stopPlayback()
...
local Toggle = AutoWalkTab:CreateToggle({
    ...
    Callback = function(Value)
        if Value then
            playSingleCheckpointFile("checkpoint_15.json", 12)
        else
            autoLoopEnabled = false
            isManualMode = false
            stopPlayback()
...
local Toggle = AutoWalkTab:CreateToggle({
    ...
    Callback = function(Value)
        if Value then
            playSingleCheckpointFile("checkpoint_16.json", 13)
        else
            autoLoopEnabled = false
            isManualMode = false
            stopPlayback()
...
local Toggle = AutoWalkTab:CreateToggle({
    ...
    Callback = function(Value)
        if Value then
            playSingleCheckpointFile("checkpoint_17.json", 14)
        else
            autoLoopEnabled = false
            isManualMode = false
            stopPlayback()
...
local Toggle = AutoWalkTab:CreateToggle({
    ...
    Callback = function(Value)
        if Value then
            playSingleCheckpointFile("checkpoint_18.json", 15)
        else
            autoLoopEnabled = false
            isManualMode = false
            stopPlayback()
...
local Toggle = AutoWalkTab:CreateToggle({
    ...
    Callback = function(Value)
        if Value then
            playSingleCheckpointFile("checkpoint_19.json", 16)
        else
            autoLoopEnabled = false
            isManualMode = false
            stopPlayback()
...
local Toggle = AutoWalkTab:CreateToggle({
    ...
    Callback = function(Value)
        if Value then
            playSingleCheckpointFile("checkpoint_20.json", 17)
        else
            autoLoopEnabled = false
            isManualMode = false
            stopPlayback()
